...
addStd.addEventListener('click',function(e){
    ...
    let myObj={
        name:name.value,email:email.value,gender:gender,website:website.value,skills:skills
    }
...
function showStudents()
{
    ...
    studentList.forEach(function(element,index)  {
        ...
        <img src="https://us.123rf.com/450wm/afe207/afe2071602/afe207160200158/52329668-photo-de-profil-d-avatar-masculin-ombre-l%C3%A9g%C3%A8re-de-silhouette.jpg?ver=6" class="rounded-circle" alt="student image" style="width:12rem; height:12rem;">
        </div>
        <div class="col-6">
        ...
        <button href="#" id="${index}" onclick="deleteStudent(this.id)"  class="btn btn-danger">Delete  Student</button><br><br><hr>
        </div>
        </div>`
    });
